#############################################################################
# Makefile for building: tp09
# Generated by qmake (2.01a) (Qt 4.8.7) on: mar. mars 26 15:46:13 2019
# Project:  main.pro
# Template: app
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/tp091.0.0 || $(MKDIR) .tmp/tp091.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/tp091.0.0/ && $(COPY_FILE) --parents shader.h meshLoader.h trackball.h grid.h camera.h viewer.h .tmp/tp091.0.0/ && $(COPY_FILE) --parents shader.cpp meshLoader.cpp trackball.cpp grid.cpp camera.cpp main.cpp viewer.cpp .tmp/tp091.0.0/ && (cd `dirname .tmp/tp091.0.0` && $(TAR) tp091.0.0.tar tp091.0.0 && $(COMPRESS) tp091.0.0.tar) && $(MOVE) `dirname .tmp/tp091.0.0`/tp091.0.0.tar.gz . && $(DEL_FILE) -r .tmp/tp091.0.0
